# https://gist.github.com/Lenochxd/9d1346d83cec1b7d6c577828de7db206
...
class Logger:
    def __init__(self, from_updater=False):
        ...
        self.log_file = f"{self.log_dir}/{date_str}-bishokus.log"
    ...
    def exception(self, exception, message=None, expected=False, log_traceback=True, print_log=True):
        """
